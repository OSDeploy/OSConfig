...
#	Main
#======================================================================================
#	Windows 7 Lockscreen Background
#======================================================================================
$Source = "$env:ProgramData\OSConfig\Background\LockScreen.jpg"
$Destination = "$env:SystemRoot\System32\oobe\Info\Backgrounds\BackgroundDefault.jpg"
...
if (Test-Path $Source) {
	if ($ProductName -like "*Windows 7*") {
		...
		Write-Host "Copying Windows 7 Lockscreen Background" -ForegroundColor Cyan
